...
public class DataTypeChart {
    ...
    static {
        // NORMAL chart
        Map<DataType, Double> normalRels = new EnumMap<>(DataType.class);
        normalRels.put(DataType.ROCK, 0.5);
        normalRels.put(DataType.BUG, 1.0);
        normalRels.put(DataType.GHOST, 0.0);
        normalRels.put(DataType.STEEL, 0.5);
        DAMAGE_MULTIPLIERS.put(DataType.NORMAL, normalRels);
